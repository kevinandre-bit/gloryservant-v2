...
class PersonalProfileController extends Controller
{
	public function index() 
	{
		...
		$campus_data = table::campusdata()->where('reference', $id)->first();
        ...
        return view('personal.personal-profile-view', compact('profile', 'campus_data', 'profile_photo', 'leavetype', 'leavegroup'));
    }
