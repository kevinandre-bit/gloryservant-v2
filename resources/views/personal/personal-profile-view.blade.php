                ...
                <div class="box box-success">
                    <div class="box-body employee-info">
                            ...
                            @if($profile_photo != null)
                                <img class="avatar border-white" src="{{ asset('/assets2/faces/'.$profile_photo) }}" alt="profile photo"/>
                            @else
                                <img class="avatar border-white" src="{{ asset('/assets2/images/faces/default_user4.jpg') }}" alt="profile photo"/>
                            @endif
                            </div>
                            <p class="description text-center">
                                ...
                                <table style="width: 100%" class="profile-tbl">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ __("ID no.") }}</td>
                                            <td><span class="p_value">@isset($campus_data->idno) {{ $campus_data->idno }} @endisset</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </p>
                    ...
                    <div class="box-body employee-info">
                        <table class="tablelist">
                            <tbody>
                                ...
                                <tr>
                                    <td><p>{{ __("Temperament") }}</span></p></td>
                                    <td><p>@isset($profile->height) {{ $profile->height }} @endisset</p></td>
                                </tr>
                                <tr>
                                    <td><p>{{ __("Love Language") }}</span></p></td>
                                ...
                                <tr>
                                    <td>{{ __("campus") }}</td>
                                    <td>@isset($campus_data->campus) {{ $campus_data->campus }} @endisset</td>
                                </tr>
                                <tr>
                                    <td><p>{{ __("ministry") }}</p></td>
                                    <td><p>@isset($campus_data->ministry) {{ $campus_data->ministry }} @endisset</p></td>
                                </tr>
                                <tr>
                                    <td>{{ __("Position") }}</td>
                                    <td>@isset($campus_data->jobposition) {{ $campus_data->jobposition }} @endisset</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        @isset($leavetype)
                                            @isset($leavegroup) 
                                                @isset($campus_data->leaveprivilege)
                                                    @foreach($leavegroup as $lg)
                                                        @if($lg->id == $campus_data->leaveprivilege)
                                                            @php
                                ...
                                <tr>
                                    ...
                                    <td><p>
                                        @isset($campus_data->startdate) 
                                            @php echo e(date("F d, Y", strtotime($campus_data->startdate))) @endphp
                                        @endisset
                                    </p></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><p>
                                        @isset($campus_data->dateregularized) 
                                            @php echo e(date("F d, Y", strtotime($campus_data->dateregularized))) @endphp
                                        @endisset
                                    </p></td>
                                </tr>
                            </tbody>
