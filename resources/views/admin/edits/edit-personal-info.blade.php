@extends('layouts.default')
    ...
    @section('meta')
        <title>Edit Employee Profile | Glory Servant</title>
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            ...
                            <div class="field">
                                ...
                                <select name="campus" class="ui search dropdown uppercase">
                                    <option value="">Select campus</option>
                                    @isset($campus)
                                        @foreach ($campus as $data)
                                            <option value="{{ $data->campus }}" @if($data->campus == $campus_details->campus) selected @endif> {{ $data->campus }}</option>
                                        @endforeach
                                    @endisset
                                </select>
                            </div>
                            <div class="field">
                                ...
                                <select name="ministry" class="ui search dropdown uppercase ministry">
                                    <option value="">Select ministry</option>
                                    @isset($ministry)
                                        @foreach ($ministry as $data)
                                            <option value="{{ $data->ministry }}" @if($data->ministry == $campus_details->ministry) selected @endif> {{ $data->ministry }}</option>
                                        @endforeach
                                    @endisset
                                </select>
                            </div>
                            <div class="field">
                                ...
                                <div class="ui search dropdown selection uppercase jobposition">
                                    <input type="hidden" name="jobposition" value="{{$campus_details->jobposition}}">
                                    <i class="dropdown icon"></i>
                                    <div class="text">{{$campus_details->jobposition}}</div>
                                    <div class="menu">
                                    @isset($jobtitle)
                                        @isset($ministry)
                                            @foreach ($jobtitle as $data)
                                                @foreach ($ministry as $dept)
                                                    @if($dept->id == $data->dept_code)
                                                        <div class="item" data-value="{{ $data->jobtitle }}" data-dept="{{ $dept->ministry }}" @if($data->jobtitle == $campus_details->jobposition) selected @endif>{{ $data->jobtitle }}</div>
                                                    @endif
                                                @endforeach
                                            @endforeach
                                        @endisset
                            ...
                            <div class="field">
                                ...
                                <input type="text" class="uppercase" name="idno" value="@isset($campus_details->idno){{ $campus_details->idno }}@endisset">
                            </div>
                            <div class="field">
                                <label>{{ __('Email Address (campus)') }}</label>
                                <input type="email" name="corporate_email" value="@isset($campus_details->corporate_email){{ $campus_details->corporate_email }}@endisset" class="lowercase">
                            </div>
                            <div class="field">
                                ...
                                <select name="leaveprivilege" class="ui dropdown uppercase">
                                    ...
                                    @isset($leavegroup) 
                                        @foreach($leavegroup as $lg)
                                            <option value="{{ $lg->id }}" @isset($campus_details->leaveprivilege) @if($lg->id == $campus_details->leaveprivilege) selected @endif @endisset>{{ $lg->leavegroup }}</option>
                                        @endforeach
                                    @endisset
                                </select>
                            </div>
                            ...
                            <div class="field">
                                ...
                                <input type="text" name="startdate" value="@isset($campus_details->startdate){{ $campus_details->startdate }}@endisset" class="airdatepicker" placeholder="Date">
                            </div>
                            <div class="field">
                                <label>{{ __('Date Regularized') }}</label>
                                <input type="text" name="dateregularized" value="@isset($campus_details->dateregularized){{ $campus_details->dateregularized }}@endisset" class="airdatepicker" placeholder="Date">
                            </div>
                            <br>
                        </div>
                    </div>
