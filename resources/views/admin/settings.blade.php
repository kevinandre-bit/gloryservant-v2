@extends('layouts.default')
    ...
    @section('meta')
        <title>General Settings | Glory Servant</title>
            ...
            <div class="box box-success">
                <div class="box-body">
                    ...
                    <div class="ui secondary blue pointing tabular menu">
                        ...
                        <a class="item" data-tab="attribution">{{ __("Team Roles") }}</a>
                        <a class="item" data-tab="integration">{{ __("Integration Process") }}</a>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="tab-content">
                                <p class="license col-md-6" style="margin-bottom:0">
                                    <h3 style="margin-top:0" class="ui header">GloryServant – A Purpose-Driven Volunteer Management Platform</h3>
                                    <p>Empower your mission. Organize your team. Serve with excellence.GloryServant is a volunteer coordination and service management system designed for tabernacle of glory ministries. Easily track, support, and empower volunteers as they serve with passion and purpose.</p>
                                    <h4 class="ui header">Features</h4>
                                    <ul>
                                        <li>Volunteer Profiles & Team Management</li>
                                        <li>Time & Availability Tracking</li>
                                        <li>Shift & Role Scheduling</li>
                                        <li>Leave & Time Off Requests</li>
                                        <li>Event & Service Planning</li>
                                        <li>Reports & Insights</li>
                                        <li>Multi-Ministry & Campus Support</li>
                                        <li>Volunteer Self-Service Portal</li>
                                    </ul>
                                    <div class="footer-text">
                                        <div class="sub header">Version 1.1</div>
                                        <div class="sub header">Copyright (c) 2025 Tabernacle of Glory. All rights reserved.</div>
                                    </div>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="tab-content">
                                <p class="license col-md-6" style="margin-bottom:0">
                                        <h3>Admin Team</h3>
                                        <ul>
                                          <li><strong>Oversee the Asana Projects:</strong> MelPhleg, MelCholr</li>
                                          <li>Build out Asana Projects based on structure or project houses</li>
                                          <li>Assign task via Asana</li>
                                          <li>Check for task, project updates on Asana</li>
                                          <li>Review projected Asana timeline for upcoming events, task or project</li>
                                          <li>Send updates to team members or team leaders regarding due dates on tasks</li>
                                        </ul>
                                        
                                        <h4>Communication Master Calendar</h4>
                                        <ul>
                                          <li><strong>Team:</strong> MelPhleg, MelCholr</li>
                                          <li>Review social media calendar for post accuracy</li>
                                          <li>Review major events and holidays in countries with TG campuses</li>
                                          <li>Create a master communications calendar with all of TG upcoming events</li>
                                        </ul>
                                        
                                        <h4>Volunteer Management</h4>
                                        <ul>
                                          <li><strong>Team:</strong> Melsan, MelCholr</li>
                                          <li>Speak to volunteers regarding availabilities</li>
                                          <li>Create a mass schedule for each communications department</li>
                                          <li>Research software to calculate volunteer hours</li>
                                          <li>Follow up with volunteers about schedule changes</li>
                                          <li>Create recruitment plan across campuses</li>
                                          <li>Oversee follow-up with inactive volunteers</li>
                                        </ul>
                                        
                                        <h4>Archiving</h4>
                                        <ul>
                                          <li><strong>Team:</strong> Mel, Phelg</li>
                                          <li>Comms Structure Note Document – Miami Campus</li>
                                          <li>Create a major title system communicated throughout all departments</li>
                                          <li>Organize the Google Drive Archive</li>
                                          <li>Restructure the current archive system</li>
                                        </ul>
                                        
                                        <h4>Additional Tasks</h4>
                                        <ul>
                                          <li><strong>Note Taking:</strong> Mel, Phelg, Cholr</li>
                                          <li><strong>Data Entry:</strong> Mel, Phelg, Cholr</li>
                                          <li><strong>Assist. CMO & Communication Leads:</strong> Melsan, MelCholr</li>
                                          <li><strong>Team:</strong> Val, Kevin, Chef, Ruthie, Frank, Box, Roodney, Stacy</li>
                                          <li><strong>Checklists Monitoring:</strong> MelPhleg, MelCholr</li>
                                          <li><strong>Volunteer Report:</strong> MelPhleg, MelCholr</li>
                                          <li><strong>Monitor Radio Stations (if live):</strong> Mel, Phelg, Cholr</li>
                                        </ul>
                                        
                                        <h3>Distribution Coordinators (Platform Coverage)</h3>
                                        <ul>
                                          <li><strong>In-Service:</strong> Onstage & content on:
                                            <ul>
                                              <li>Youtube</li>
                                              <li>Facebook</li>
                                              <li>Instagram</li>
                                          ...
                                          <li>Radio (Shekinah & Others)</li>
                                          <li>TV (Shekinah & Others)</li>
                                          <li>WhatsApp</li>
                                        ...
                                        <ul>
                                          ...
                                          <li>HP Members</li>
                                          <li>Volunteers</li>
                                          <li>Facebook Crossposts</li>
                                          <li>Printed Ads (billboards, flyers, banners, etc.)</li>
                                          <li>Yard Signs</li>
                                          <li>Buses</li>
                                          <li>Store Fonts</li>
                                          <li>Eventbrite</li>
                                        ...
                                        <h4>Distribution Research</h4>
                                        <ul>
                                          <li>Targeting all potential places to distribute</li>
                                        </ul>
                                        
                                        <h3>Branding</h3>
                                        <ul>
                                          <li>Responsible for anything related to TG Branding</li>
                                        </ul>
                                        
                                        <h4>Social Media</h4>
                                        <ul>
                                          <li>YT Shekinah Pages</li>
                                          <li>Facebook Shekinah Pages</li>
                                          <li>IG Shekinah Pages</li>
                                          <li>All other pages</li>
                                          <li>Everything TG and Shekinah FM content</li>
                                        </ul>
                                        
                                        <h4>Traditional Media</h4>
                                        <ul>
                                          <li>Responsible for Acquisition/Rental of Radio & TV</li>
                                          <li>Strategist for Viewership & Listeners</li>
                                        </ul>
                                        
                                        <h4>YouTube</h4>
                                        <ul>
                                          <li>Create videos for YT</li>
                                          <li>Create graphics for YT</li>
                                          <li>Upload on YT per strategy checklists</li>
                                        </ul>
                                        
                                        <h4>Content Creation</h4>
                                        <ul>
                                          <li>Follow checklist for uploads and posting</li>
                                        </ul>
                                        
                                        <h4>Video Editing</h4>
                                        <ul>
                                          <li>Create videos for all platforms</li>
                                          <li>Create promotional videos (regular announcements & major events)</li>
                                        </ul>
                                        
                                        <h4>App</h4>
                                        <ul>
                                          <li>All strategies for APP downloads</li>
                                          <li>95% shared content from other Communication departments</li>
                                          <li>5% UX/UI content (Graphics, visuals)</li>
                                          <li>Monitoring App Updates</li>
                                        </ul>
                                        
                                        <h4>Events</h4>
                                        <ul>
                                          <li>Execute marketing strategies to meet event objectives (In-house and Online)</li>
                                          <li>Manage communication activities to support event goals</li>
                                          <li>Monitor plans and oversee execution of strategies</li>
                                          <li>Event Marketing Schedule</li>
                                        </ul>
                                        
                                        <h4>Public Relations</h4>
                                        <ul>
                                          <li>Develop relationships in the press and build the right image online</li>
                                          <li>Press Release</li>
                                        ...
                                        <h4>Website</h4>
                                        <ul>
                                          <li>Monitor website updates</li>
                                        </ul>
                                        
                                        <h4>Audio Editors</h4>
                                        <ul>
                                          <li>Shekinah Radio</li>
                                          <li>Rented Radios</li>
                                        </ul>
                                        
                                        <h4>TV & Radio Producers</h4>
                                        <ul>
                                          <li>Executive Producers</li>
                                          <li>Financing</li>
                                          <li>Manages Programming</li>
                                          <li>Managing Ads Placement</li>
                                        </ul>
                                        ...
                                        <h4>Sales</h4>
                                        <ul>
                                          <li><strong>Book Sales</strong></li>
                                          <li>Online Sales (Books)</li>
                                          <li>E-Commerce Book Sales</li>
                                          <li>Amazon (Online)</li>
                                          <li>Website Book Sales</li>
                                        </ul>
                                        
                                        <h4>Retail (Physical Distribution Channel)</h4>
                                        <ul>
                                          <li>Stores</li>
                                          <li>Product Sales</li>
                                        </ul>
                    ...
                    <div class="ui tab" data-tab="integration">
                        <div class="col-md-12">
                            <div class="tab-content">
                                <p class="license col-md-6" style="margin-bottom:0">
                                        <h3>New Ministry Volunteer Integration Process</h3>
                                          <ul class="process">
                                              <li>
                                                <strong>Week 1 – Registration:</strong><br>
                                                Register the new stagee in the system and create their volunteer profile. This marks the official beginning of the 90-day integration process.
                                              </li><br>
                                            
                                              <li>
                                                <strong>Week 1 – Coach Assignment:</strong><br>
                                                Assign the stagee to an Integration Coach who will accompany them throughout the process, providing encouragement and regular check-ins.
                                              </li><br>
                                            
                                              <li>
                                                <strong>Week 1 – Pre-Interview Call:</strong><br>
                                                Schedule and conduct a brief 5-minute phone interview to gather initial information and assess general interest. Update the volunteer's profile with insights from this conversation.
                                              </li><br>
                                            
                                              <li>
                                                <strong>Week 2 – Initial Qualification (I-101 Eligibility):</strong><br>
                                                Review the information from the pre-interview and determine if the stagee is qualified to move forward to the I-101 Interview. Update their status accordingly.
                                              </li><br>
                                            
                                              <li>
                                                <strong>Week 3 – I-101 Interview:</strong><br>
                                                Conduct a more in-depth interview to evaluate the stagee’s motivations, ministry fit, and spiritual maturity. Based on this interview, determine their readiness for orientation (I-102) and update the profile.
                                              </li><br>
                                            
                                              <li>
                                                <strong>Week 4 – Orientation Meeting (I-102 Stage):</strong><br>
                                                Host an orientation session where you explain the mission, vision, expectations, rules, and the roles of various ministry departments. This session helps the stagee make an informed department choice.
                                              </li><br>
                                            
                                              <li>
                                                <strong>Week 5 – Department Selection:</strong><br>
                                                After orientation, allow the stagee to choose the department they feel called to. Update their profile with this information and notify the department leader.
                                              </li><br>
                                            
                                              <li>
                                                <strong>Weeks 6–12 – Stagee Period (Ongoing Observation):</strong><br>
                                                Begin the 60-day serving period within the selected department. Monitor engagement, punctuality, character, and skill development during this time. The coach and department head provide feedback and mentorship.
                                              </li><br>
                                            
                                              <li>
                                                <strong>Week 13 – Final Interview (I-103 Stage):</strong><br>
                                                At the end of the 90-day integration, conduct a final interview to review their journey, discuss growth, gather feedback, and assess readiness for full volunteer status.
                                              </li><br>
                                            
                                              <li>
                                                <strong>Week 13 – Volunteer Recognition Ceremony:</strong><br>
                                                If the stagee completes all stages successfully, recognize them as an <em>Active Volunteer</em> in a special ceremony during a church service or team gathering. Update their profile to reflect active status.
                                              </li><br>
                                            </ul>
