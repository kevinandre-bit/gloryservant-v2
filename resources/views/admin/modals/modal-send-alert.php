<div class="ui modal medium sendAlert">
    <div class="header">{{ __("Send Alert") }}</div>
    <div class="content">
        <form id="send_alert_form" action="{{ url('users/register') }}" class="ui form add-user" method="post" accept-charset="utf-8">
            @csrf
            <div class="field">
