<div class="ui modal tiny import">
    <div class="header">{{ __("Import ministries") }}</div>
    <div class="content">
    <form action="{{ url('import/fields/ministry') }}" class="ui form" method="post" accept-charset="utf-8"enctype="multipart/form-data" >
        @csrf
        <div class="field">
